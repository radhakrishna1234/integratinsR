...
println "==============================>>>>>>> printed3"
if("1".equals(TenantNo)) {
postDefaultTenant(createtenanturl,AuthToken,server+"/otdsws/oauth2","auth1","123456789")
//updateDefaultTenant( defaulttenanturl,  defaultOTDSAuthenticationURL,  oauthBasicClientName,  defaultOAuth2SecretKey,   AuthToken)
createtenant(createtenanturl,"dummy",oauth2_URL, otdsRestEndPoint, "", "", "11111111111111111111111111", "1",  "1", "1", AuthToken)
updateDefaultVolume(sysCon_UpdateVolume_URL,"dummy",AuthToken);
}

createtenant(createtenanturl,ihubtenantName,oauth2_URL, otdsRestEndPoint, oauthClientName, oauthSecretKey, resourceID, homeFolderAttribute,  groupDescriptionAttribute, adminGroupName, AuthToken)
...
def otdsTicketTenant(String otdsTicketURL, String AuthToken, String resourceID, String OTDSBaseURL, String defaultHomeFolder, String groupNameAttribute, String adminGroupName) {
 ...
 PlatformConfig.ihubConnManager( endPoint, platformUserName, platformPassword, ihubtenantNameRandom, iHUB_URL, oauthClientName, "123456789");
 if(isClassicIHUB.equals("true")) {
