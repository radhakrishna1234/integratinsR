...
//arr[1] =config.getProperty("CSURL"); 
 ...
 otdsConfig.createResource(orgCreateResourceURL, method,  orgAdminAuthendPoint, orgAdminAuthPayload, resourceName, platformOtdsPushURL, platformOrg+"user2", "Opentext1!")
